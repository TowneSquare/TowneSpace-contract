...
module townespace::studio {
    ...
    */
    ...
    public entry fun compose_object(
        ...
        // events::emit_composition_event(
        //     events::composable_token_metadata(composable_token_object),
        //     events::object_token_metadata(object_token_object),
        //     new_uri
        // );
    }
    ...
    public entry fun decompose_object(
        ...
        // Update uri
        set_uri(owner, composable_token_object, new_uri);
        // events::emit_decomposition_event(
        //     events::composable_token_metadata(composable_token_object),
        //     events::object_token_metadata(object_token_object),
        //     new_uri
        // );
