...
module townespace::studio {
    ...
    public entry fun equip_trait(
        ...
        core::equip_trait_internal(owner, composable_obj, trait_obj);
        // Update uri
        core::set_uri(owner, composable_obj, new_uri);
    }
    ...
    public entry fun unequip_trait(
        ...
        core::unequip_trait_internal(owner, composable_obj, trait_obj);
        // Update uri
        core::set_uri(owner, composable_obj, new_uri);
    }
    ...
    public entry fun decompose_entire_token(
        ...
        // Update uri
        core::set_uri<core::Composable>(owner, composable_obj, new_uri);
    }
